...
*/
function renderproductdetails(urlimage,ptext,pbrand,pprice,productcontent,photos)
{
  ...
  var productbrand = $("<p>").addClass("productbrand").text(pbrand).css("font-size","30px")
  rightpreview.append(productbrand)
 var productprice = $("<p>").addClass("productprice").text("Price Rs:").css("font-size","30px")
 var price = $("<span>").addClass("price").text(pprice).css("font-size","30px")
 productprice.append(price)
 rightpreview.append(productprice)
var pdesc = $("<p>").addClass("pdescription").text("Description").css("font-size","30px")
rightpreview.append(pdesc)
var pcontent = $("<p>").addClass("productcontent").text(productcontent).css("font-size","30px")
rightpreview.append(pcontent)
var preview = $("<p>").addClass("preview").text("Product Preview").css("font-size","30px")
...
$(".maincontainer").append(leftpreview)
$(".maincontainer").append(rightpreview)
       ...
       for(var k=0;k< getproductdetails.length;k++)
        {
           ...
           {
             pos = k;
             renderproductdetails(getproductdetails[k].preview,getproductdetails[k].name,getproductdetails[k].brand,getproductdetails[k].price,getproductdetails[k].description,getproductdetails[k].photos)
